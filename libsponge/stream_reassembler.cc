...
void StreamReassembler::push_unassembled_substring_(const std::string &data,
    ...
    string data_written =
        data.substr(current_write_begin_index - begin_index, current_write_end_index - current_write_begin_index);
    ...
    if (current_write_end_index < end_index) {
        push_unassembled_substring_(
            data.substr(current_write_end_index - begin_index), current_write_end_index, end_index);
    }
}
...
void StreamReassembler::push_substring(const string &data, const size_t index, const bool eof) {
    ...
    push_unassembled_substring_(
        data.substr(current_data_index_begin - index, current_data_index_end - current_data_index_begin),
        current_data_index_begin,
        current_data_index_end);
    pop_unassembled_to_output_();
